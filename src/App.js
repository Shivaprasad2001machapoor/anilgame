...
class App extends Component {
  ...
  updateThumbnails = () => {
    ...
    this.setState({thumbnails: filteredThumbnails})
  }

  handleTabClick = tabId => {
    this.setState({activeTab: tabId}, this.updateThumbnails)
  }

  handleThumbnailClick = thumbnail => {
    const {currentImage} = this.state
    if (thumbnail.imageUrl === currentImage) {
      this.setState(prevState => ({
  ...
  render() {
    ...
    return (
      <div className="app-container">
            ...
            {thumbnails.map(thumbnail => (
              <li key={thumbnail.id}>
                <button
                  type="button"
                  className="thumbnail"
                  onClick={() => this.handleThumbnailClick(thumbnail)}
                >
        ...
        {isGameActive ? (
          <>
            <img src={currentImage} alt="match" className="current-image" />
          </>
        ) : (
